...
public class TraceDealIncrementStockLargeDealAction extends STOCKCommonAction implements Action {

	private static Logger logger = LoggerFactory.getLogger(TraceDealIncrementStockLargeDealAction.class);
	...
	public void handle(Context ctx) throws Exception {
		...
		ArrayList<HashMap> newRerultList = (ArrayList) sqlMap
				.queryForList("TraceDealIncrementStockLargeDealAction.queryNewDealIncreStockList", ctx.getDataMap());
		...
		if (newRerultList == null || newRerultList.isEmpty()) {
			...
			for (HashMap requestMap : newRerultList) {
				...
				HashMap resultMap = sqlMap.queryForObject("TraceDealIncrementStockLargeDealAction.queryStockDealInfo",
						requestMap);
				...
				if (resultMap == null || resultMap.isEmpty()) {
					...
					sqlMap.update("TraceDealIncrementStockLargeDealAction.updateNewDealIncreStockInfo", requestMap);
		...
		ArrayList<HashMap> rerultList = (ArrayList) sqlMap
				.queryForList("TraceDealIncrementStockLargeDealAction.queryDealIncreStockList", ctx.getDataMap());
		...
		if (rerultList == null || rerultList.isEmpty()) {
			...
			for (HashMap requestMap : rerultList) {
				...
				if (resultMap == null || resultMap.isEmpty()) {
					...
					sqlMap.update("TraceDealIncrementStockLargeDealAction.updateDealIncreStockInfo", requestMap);
