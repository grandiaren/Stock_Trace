...
public class GetSHStockListAction extends STOCKCommonAction implements Action {

	private static Logger logger = LoggerFactory.getLogger(GetSHStockListAction.class);
	...
	public void handle(Context ctx) throws Exception {
		...
		sqlMap.delete("GetSHStockListAction.clearStockList");
		...
		while (!endFlag) {
			...
			HashMap resultMap = STOCKJuHeManager.getSHStockList("a", page, 4);
...
//			}
			...
			for (HashMap listMem : resultList) {
				...
				sqlMap.insert("GetSHStockListAction.insertStockList", paramMap);
